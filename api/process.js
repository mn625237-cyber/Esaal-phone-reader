...
// ✅ استخدام الموديل المستقر والمعتمد رسمياً على المفاتيح المجانية
const AI_MODEL = 'gemini-2.5-flash';
const GEMINI_ENDPOINT = `https://generativelanguage.googleapis.com/v1/models/${AI_MODEL}:generateContent`;

// ✏️ البرومبت المخصص حصرياً لاستخراج رقم الهاتف المصري من الريسيت
...
using exactly 11 digits and no other characters, or {"phone": null} if you cannot find one.`;
